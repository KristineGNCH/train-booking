...
import { passengersPriceChange } from "../../reducers/Slices/passengersSlice";

import rub from "../../assets/svg/ruble.svg";
import LuxClass from "../../assets/svg/Luxe.svg";
import KupeClass from "../../assets/svg/Coupe.svg";
import PlatskartClass from "../../assets/svg/Sedentary.svg";
import SeatsClass from "../../assets/svg/Economy.svg";

import Price from "./Price";
import Services from "./Facilities";
      ...
      <div className="coach-info">
        ...
        <div className="coach-info-card coach-info-card--seats">
          ...
          {type.platzcart && (
            <p className="coach-info-text">
              Боковые{" "}
              <span>{seatsList.filter((el) => el.index > 32).length}</span>
            </p>
          )}
        </div>
        ...
        <div className="coach-info-card coach-info-card--services">
          ...
          <div className="coach-services">
            ...
            {coach.have_wifi && (
              <Services service="wifi" id={coach._id} type={typeTicket} />
            )}
